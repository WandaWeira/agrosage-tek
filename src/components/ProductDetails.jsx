...
const ProductDetails = ({ products }) => {
  ...
  return (
    <div className="h-auto mt-10">
      ...
      <div className="flex">
        <div>
          <div className="w-1/2 mx-60 my-10">
            <h2 className="font-bold text-2xl my-10">{product.name}</h2>
            <p>
              The Fresh Stops are simply large communal cold storage facilities
              powered by either solar or electricity, depending on their
              location. They are designed to provide controlled humidity and
              temperature conditions that preserve the freshness and quality of
              agricultural products for at least three months. Fresh stops are
              cooled using air conditioning systems and powered by solar energy,
              enabling them to operate at negligible cost as opposed to
          ...
          <div className="w-1/2 mx-60 my-10">
            ...
            <p>
              ...
              flexibility makes Fresh Stops the perfect choice for storing a
              wide range of agricultural products, ensuring they remain in
              optimal condition.
            </p>
          </div>
        </div>
