  ...
  return (
    <div className="h-auto mt-10">
      ...
      <div className="w-1/2 mx-60 my-10">
        ...
        <p>
          By using solar-powered air conditioner units to cool food, as opposed
          to the traditional separate condenser, compressor, and evaporator
          units found in conventional cold storage rooms, the operation cost per
          unit cooling time is slashed by 50%. This significant reduction in
          energy costs for SMEs increases their income and enhances their
      ...
      <div className="w-1/2 mx-60 my-10">
        ...
        <p>
          Fresh stop facilities come equipped with a thermostat that allows you
          to adjust the temperature and humidity conditions easily. This
